...
void runBDT_1bjet(int booster_idx, pat::XGBooster booster, float jet_pt, float jet_eta, float jet_phi, float jet_mass, float pt_1, float eta_1, float phi_1, float mass_1, float pt_2, float eta_2, float phi_2, float mass_2, float met, float met_phi, float d_zeta, int njets, float pt_vis_nominal, float D_zeta_nominal, float m_btautau_vis_nominal, float mtMET_1_nominal, float mtMET_2_nominal, float pt_1_nominal, float& BDTval);
void runBDT_2bjet(int booster_idx, pat::XGBooster booster, float jet_1_pt, float jet_1_eta, float jet_1_phi, float jet_1_mass, float jet_2_pt, float jet_2_eta, float jet_2_phi, float jet_2_mass, float pt_1, float eta_1, float phi_1, float mass_1, float pt_2, float eta_2, float phi_2, float mass_2, float met, float met_phi, float d_zeta, float m_btautau_vis_nominal, float mtMET_1_nominal, float pt_vis_nominal, float& BDTval); 
...
void readdir(TDirectory *dir, optutl::CommandLineParser parser, char TreeToUse[], pat::XGBooster boosters[]) {
  ...
  int booster_idx = -1;
    ...
    if (std::string(key->GetName()) == "mutau_tree") {
      ...
      booster_idx = 2;
    } // pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_nominal, metphi_nominal, D_zeta_nominal, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_nominal);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, pt_1_es1Up, eta_1, phi_1, m_1_es1Up, pt_2_nominal, eta_2, phi_2, m_2, met_es1Up, metphi_es1Up, D_zeta_es1Up, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_es1Up);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, pt_1_es1Down, eta_1, phi_1, m_1_es1Down, pt_2_nominal, eta_2, phi_2, m_2, met_es1Down, metphi_es1Down, D_zeta_es1Down, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_es1Down);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_es2Up, eta_2, phi_2, m_2_es2Up, met_es2Up, metphi_es2Up, D_zeta_es2Up, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_es2Up);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_es2Down, eta_2, phi_2, m_2_es2Down, met_es2Down, metphi_es2Down, D_zeta_es2Down, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_es2Down);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_UESUp, metphi_UESUp, D_zeta_UESUp, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_UESUp);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_UESDown, metphi_UESDown, D_zeta_UESDown, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_UESDown);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_ResponseUp, metphi_ResponseUp, D_zeta_ResponseUp, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_ResponseUp);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_ResponseDown, metphi_ResponseDown, D_zeta_ResponseDown, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_ResponseDown);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_ResolutionUp, metphi_ResolutionUp, D_zeta_ResolutionUp, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_ResolutionUp);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_ResolutionDown, metphi_ResolutionDown, D_zeta_ResolutionDown, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_ResolutionDown);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetAbsoluteUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetAbsoluteUp_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetAbsoluteUp, metphi_JetAbsoluteUp, D_zeta_JetAbsoluteUp, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetAbsoluteUp);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetAbsoluteDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetAbsoluteDown_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetAbsoluteDown, metphi_JetAbsoluteDown, D_zeta_JetAbsoluteDown, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetAbsoluteDown);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetAbsoluteyearUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetAbsoluteyearUp_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetAbsoluteyearUp, metphi_JetAbsoluteyearUp, D_zeta_JetAbsoluteyearUp, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetAbsoluteyearUp);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetAbsoluteyearDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetAbsoluteyearDown_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetAbsoluteyearDown, metphi_JetAbsoluteyearDown, D_zeta_JetAbsoluteyearDown, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetAbsoluteyearDown);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetBBEC1Up_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetBBEC1Up_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetBBEC1Up, metphi_JetBBEC1Up, D_zeta_JetBBEC1Up, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetBBEC1Up);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetBBEC1Down_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetBBEC1Down_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetBBEC1Down, metphi_JetBBEC1Down, D_zeta_JetBBEC1Down, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetBBEC1Down);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetBBEC1yearUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetBBEC1yearUp_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetBBEC1yearUp, metphi_JetBBEC1yearUp, D_zeta_JetBBEC1yearUp, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetBBEC1yearUp);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetBBEC1yearDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetBBEC1yearDown_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetBBEC1yearDown, metphi_JetBBEC1yearDown, D_zeta_JetBBEC1yearDown, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetBBEC1yearDown);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetEC2Up_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetEC2Up_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetEC2Up, metphi_JetEC2Up, D_zeta_JetEC2Up, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetEC2Up);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetEC2Down_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetEC2Down_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetEC2Down, metphi_JetEC2Down, D_zeta_JetEC2Down, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetEC2Down);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetEC2yearUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetEC2yearUp_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetEC2yearUp, metphi_JetEC2yearUp, D_zeta_JetEC2yearUp, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetEC2yearUp);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetEC2yearDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetEC2yearDown_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetEC2yearDown, metphi_JetEC2yearDown, D_zeta_JetEC2yearDown, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetEC2yearDown);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetFlavorQCDUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetFlavorQCDUp_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetFlavorQCDUp, metphi_JetFlavorQCDUp, D_zeta_JetFlavorQCDUp, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetFlavorQCDUp);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetFlavorQCDDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetFlavorQCDDown_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetFlavorQCDDown, metphi_JetFlavorQCDDown, D_zeta_JetFlavorQCDDown, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetFlavorQCDDown);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetHFUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetHFUp_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetHFUp, metphi_JetHFUp, D_zeta_JetHFUp, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetHFUp);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetHFDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetHFDown_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetHFDown, metphi_JetHFDown, D_zeta_JetHFDown, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetHFDown);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetHFyearUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetHFyearUp_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetHFyearUp, metphi_JetHFyearUp, D_zeta_JetHFyearUp, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetHFyearUp);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetHFyearDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetHFyearDown_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetHFyearDown, metphi_JetHFyearDown, D_zeta_JetHFyearDown, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetHFyearDown);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetRelativeBalUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetRelativeBalUp_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetRelativeBalUp, metphi_JetRelativeBalUp, D_zeta_JetRelativeBalUp, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetRelativeBalUp);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetRelativeBalDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetRelativeBalDown_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetRelativeBalDown, metphi_JetRelativeBalDown, D_zeta_JetRelativeBalDown, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetRelativeBalDown);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetRelativeSampleUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetRelativeSampleUp_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetRelativeSampleUp, metphi_JetRelativeSampleUp, D_zeta_JetRelativeSampleUp, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetRelativeSampleUp);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetRelativeSampleDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetRelativeSampleDown_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetRelativeSampleDown, metphi_JetRelativeSampleDown, D_zeta_JetRelativeSampleDown, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JetRelativeSampleDown);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JERUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JERUp_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JERUp, metphi_JERUp, D_zeta_JERUp, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JERUp);
    runBDT_1bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JERDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JERDown_1, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JERDown, metphi_JERDown, D_zeta_JERDown, njets, pt_vis_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, mtMET_2_nominal, pt_1_nominal, BDTval_JERDown);
    ...
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, bpt_deepflavour_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_nominal, metphi_nominal, D_zeta_nominal, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_nominal);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, bpt_deepflavour_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_2, pt_1_es1Up, eta_1, phi_1, m_1_es1Up, pt_2_nominal, eta_2, phi_2, m_2, met_es1Up, metphi_es1Up, D_zeta_es1Up, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_es1Up);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, bpt_deepflavour_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_2, pt_1_es1Down, eta_1, phi_1, m_1_es1Down, pt_2_nominal, eta_2, phi_2, m_2, met_es1Down, metphi_es1Down, D_zeta_es1Down, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_es1Down);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, bpt_deepflavour_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_es2Up, eta_2, phi_2, m_2_es2Up, met_es2Up, metphi_es2Up, D_zeta_es2Up, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_es2Up);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, bpt_deepflavour_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_es2Down, eta_2, phi_2, m_2_es2Down, met_es2Down, metphi_es2Down, D_zeta_es2Down, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_es2Down);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, bpt_deepflavour_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_UESUp, metphi_UESUp, D_zeta_UESUp, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_UESUp);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, bpt_deepflavour_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_UESDown, metphi_UESDown, D_zeta_UESDown, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_UESDown);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, bpt_deepflavour_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_ResponseUp, metphi_ResponseUp, D_zeta_ResponseUp, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_ResponseUp);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, bpt_deepflavour_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_ResponseDown, metphi_ResponseDown, D_zeta_ResponseDown, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_ResponseDown);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, bpt_deepflavour_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_ResolutionUp, metphi_ResolutionUp, D_zeta_ResolutionUp, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_ResolutionUp);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_1, bpt_deepflavour_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_ResolutionDown, metphi_ResolutionDown, D_zeta_ResolutionDown, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_ResolutionDown);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetAbsoluteUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetAbsoluteUp_1, bpt_deepflavour_JetAbsoluteUp_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetAbsoluteUp_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetAbsoluteUp, metphi_JetAbsoluteUp, D_zeta_JetAbsoluteUp, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetAbsoluteUp);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetAbsoluteDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetAbsoluteDown_1, bpt_deepflavour_JetAbsoluteDown_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetAbsoluteDown_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetAbsoluteDown, metphi_JetAbsoluteDown, D_zeta_JetAbsoluteDown, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetAbsoluteDown);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetAbsoluteyearUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetAbsoluteyearUp_1, bpt_deepflavour_JetAbsoluteyearUp_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetAbsoluteyearUp_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetAbsoluteyearUp, metphi_JetAbsoluteyearUp, D_zeta_JetAbsoluteyearUp, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetAbsoluteyearUp);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetAbsoluteyearDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetAbsoluteyearDown_1, bpt_deepflavour_JetAbsoluteyearDown_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetAbsoluteyearDown_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetAbsoluteyearDown, metphi_JetAbsoluteyearDown, D_zeta_JetAbsoluteyearDown, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetAbsoluteyearDown);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetBBEC1Up_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetBBEC1Up_1, bpt_deepflavour_JetBBEC1Up_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetBBEC1Up_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetBBEC1Up, metphi_JetBBEC1Up, D_zeta_JetBBEC1Up, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetBBEC1Up);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetBBEC1Down_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetBBEC1Down_1, bpt_deepflavour_JetBBEC1Down_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetBBEC1Down_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetBBEC1Down, metphi_JetBBEC1Down, D_zeta_JetBBEC1Down, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetBBEC1Down);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetBBEC1yearUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetBBEC1yearUp_1, bpt_deepflavour_JetBBEC1yearUp_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetBBEC1yearUp_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetBBEC1yearUp, metphi_JetBBEC1yearUp, D_zeta_JetBBEC1yearUp, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetBBEC1yearUp);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetBBEC1yearDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetBBEC1yearDown_1, bpt_deepflavour_JetBBEC1yearDown_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetBBEC1yearDown_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetBBEC1yearDown, metphi_JetBBEC1yearDown, D_zeta_JetBBEC1yearDown, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetBBEC1yearDown);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetEC2Up_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetEC2Up_1, bpt_deepflavour_JetEC2Up_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetEC2Up_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetEC2Up, metphi_JetEC2Up, D_zeta_JetEC2Up, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetEC2Up);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetEC2Down_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetEC2Down_1, bpt_deepflavour_JetEC2Down_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetEC2Down_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetEC2Down, metphi_JetEC2Down, D_zeta_JetEC2Down, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetEC2Down);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetEC2yearUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetEC2yearUp_1, bpt_deepflavour_JetEC2yearUp_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetEC2yearUp_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetEC2yearUp, metphi_JetEC2yearUp, D_zeta_JetEC2yearUp, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetEC2yearUp);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetEC2yearDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetEC2yearDown_1, bpt_deepflavour_JetEC2yearDown_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetEC2yearDown_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetEC2yearDown, metphi_JetEC2yearDown, D_zeta_JetEC2yearDown, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetEC2yearDown);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetFlavorQCDUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetFlavorQCDUp_1, bpt_deepflavour_JetFlavorQCDUp_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetFlavorQCDUp_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetFlavorQCDUp, metphi_JetFlavorQCDUp, D_zeta_JetFlavorQCDUp, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetFlavorQCDUp);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetFlavorQCDDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetFlavorQCDDown_1, bpt_deepflavour_JetFlavorQCDDown_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetFlavorQCDDown_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetFlavorQCDDown, metphi_JetFlavorQCDDown, D_zeta_JetFlavorQCDDown, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetFlavorQCDDown);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetHFUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetHFUp_1, bpt_deepflavour_JetHFUp_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetHFUp_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetHFUp, metphi_JetHFUp, D_zeta_JetHFUp, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetHFUp);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetHFDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetHFDown_1, bpt_deepflavour_JetHFDown_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetHFDown_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetHFDown, metphi_JetHFDown, D_zeta_JetHFDown, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetHFDown);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetHFyearUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetHFyearUp_1, bpt_deepflavour_JetHFyearUp_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetHFyearUp_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetHFyearUp, metphi_JetHFyearUp, D_zeta_JetHFyearUp, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetHFyearUp);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetHFyearDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetHFyearDown_1, bpt_deepflavour_JetHFyearDown_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetHFyearDown_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetHFyearDown, metphi_JetHFyearDown, D_zeta_JetHFyearDown, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetHFyearDown);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetRelativeBalUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetRelativeBalUp_1, bpt_deepflavour_JetRelativeBalUp_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetRelativeBalUp_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetRelativeBalUp, metphi_JetRelativeBalUp, D_zeta_JetRelativeBalUp, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetRelativeBalUp);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetRelativeBalDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetRelativeBalDown_1, bpt_deepflavour_JetRelativeBalDown_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetRelativeBalDown_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetRelativeBalDown, metphi_JetRelativeBalDown, D_zeta_JetRelativeBalDown, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetRelativeBalDown);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetRelativeSampleUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetRelativeSampleUp_1, bpt_deepflavour_JetRelativeSampleUp_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetRelativeSampleUp_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetRelativeSampleUp, metphi_JetRelativeSampleUp, D_zeta_JetRelativeSampleUp, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetRelativeSampleUp);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JetRelativeSampleDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JetRelativeSampleDown_1, bpt_deepflavour_JetRelativeSampleDown_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JetRelativeSampleDown_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JetRelativeSampleDown, metphi_JetRelativeSampleDown, D_zeta_JetRelativeSampleDown, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JetRelativeSampleDown);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JERUp_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JERUp_1, bpt_deepflavour_JERUp_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JERUp_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JERUp, metphi_JERUp, D_zeta_JERUp, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JERUp);
    runBDT_2bjet(booster_idx, boosters[booster_idx], bpt_deepflavour_JERDown_1, beta_deepflavour_1, bphi_deepflavour_1, bm_deepflavour_JERDown_1, bpt_deepflavour_JERDown_2, beta_deepflavour_2, bphi_deepflavour_2, bm_deepflavour_JERDown_2, pt_1_nominal, eta_1, phi_1, m_1, pt_2_nominal, eta_2, phi_2, m_2, met_JERDown, metphi_JERDown, D_zeta_JERDown, m_btautau_vis_nominal, mtMET_1_nominal, pt_vis_nominal, BDTval_JERDown);
  } else {
    BDTval_nominal = -10;
    BDTval_es1Up = -10;
    BDTval_es1Down = -10;
...
void runBDT_1bjet(int booster_idx, pat::XGBooster booster, float jet_pt, float jet_eta, float jet_phi, float jet_mass, float pt_1, float eta_1, float phi_1, float mass_1, float pt_2, float eta_2, float phi_2, float mass_2, float met, float met_phi, float d_zeta, int njets, float pt_vis_nominal, float D_zeta_nominal, float m_btautau_vis_nominal, float mtMET_1_nominal, float mtMET_2_nominal, float pt_1_nominal, float& BDTval) {
  ...
  if (booster_idx == 0) {
    ...
    int in_njets;
    in_pt_vis_nominal = pt_vis_nominal;
    in_D_zeta_nominal = D_zeta_nominal;
    in_b1e_dR = compute_deltaR(jet_eta, eta_1, jet_phi, phi_1); // DEFINE ORDER
    in_m_btautau_vis_nominal = m_btautau_vis_nominal;
    in_mtMET_1_nominal = mtMET_1_nominal;
    in_b1th_dR = compute_deltaR(jet_eta, eta_2, jet_phi, phi_2); // DEFINE ORDER
    in_mtMET_2_nominal = mtMET_2_nominal;
    in_njets = njets;
...
void runBDT_2bjet(int booster_idx, pat::XGBooster booster, float jet_1_pt, float jet_1_eta, float jet_1_phi, float jet_1_mass, float jet_2_pt, float jet_2_eta, float jet_2_phi, float jet_2_mass, float pt_1, float eta_1, float phi_1, float mass_1, float pt_2, float eta_2, float phi_2, float mass_2, float met, float met_phi, float d_zeta, float m_btautau_vis_nominal, float mtMET_1_nominal, float pt_vis_nominal, float& BDTval) {
  ...
  if (booster_idx == 3) {
    ...
    in_mbb = bjet12.M();
    in_m_btautau_vis_nominal = m_btautau_vis_nominal; // DEFINE CONSTITUTENTS
    in_mtMET_1_nominal = mtMET_1_nominal;
    ...
    in_pt_vis_nominal = pt_vis_nominal; // DEFINE CONSTITUTENTS
